   ...
   var newColHtml = '<div class="btn-group pull-right">' +
       ...
       '<button id="bEdit" type="button" class="" onclick="EditRow(this);">' +
       ...
       '<button id="bAcep" type="button" class="" style="display:none;" onclick="AcceptRow(this);">' +

           '<i class="bi bi-plus-square fs-5"></i>' +

       '</button>' +

       '<button id="bCanc" type="button" class="" style="display:none;" onclick="CancelRow(this);" >' +
